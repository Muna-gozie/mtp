...
$err_msg = $_GET['message'];

// echo $error_type.' '.$err_msg;
...
if(!empty($error_type) &&  !empty($err_msg)) 
{
?>
...
<div class="modalbox success col-sm-8 col-md-6 col-lg-5 center animate">
			...
			<!--/.icon-->
			<h1 style="font-size: 18px;padding-top: 1em;"> <?php echo $error_type ?> </h1>
            <p style="margin-top:-30px; font-size:14px; line-height:25px;"><?php echo $err_msg ?></p>
