...
// Here is the data we will be sending to the service
  $data = array('Firstname' => 'Steve', 'LastName' => 'Obi', 'PhoneNos' => '07062122133', 'Email' => '111@yahoo.com', 'DOB' => '2018-08-10', 'Address' => 'Lagos', 'Country' => 'test', 'Usage' => 'PRIVATE', 'InsuranceClass' => 'THIRD PARTY', 'Vehicle' => 'CAR', 'Excess' => 'WITH EXCESS', 'SumValue' => 1000000, 'TransactionID' => 'test', 'CarRegNos' => 'test', 'Carbrand' => 'test', 'CarType' => 'test', 'CarModel' => 'test', 'Registration_State' => 'test', 'ChasisNos' => 'test', 'Amount' => '5000', 'MerchantReference' => 'TR300', 'occupation' => 'test', 'StateofResidence' => 'test');


  $curl = curl_init('http://52.213.72.87:3001/webservice/interapp.asmx?WSDL');
  
  curl_setopt($curl, CURLOPT_POST, 1); //Choosing the POST method
  curl_setopt($curl, CURLOPT_URL, 'http://52.213.72.87:3001/webservice/interapp.asmx?WSDL');  // Set the url path we want to call
   ...
   function preventBack(){window.history.forward();}
    ...
    window.onunload=function(){null};
		...
		<div class="modalbox success col-sm-8 col-md-6 col-lg-5 center animate">
			...
			<p>We've sent a link for you to print your certificate and confirmation of insurance purchace to your e-mail.</p>
			<form action="../" method="post" name="form">
            <button type="submit" class="redo btn">Ok</button>
            </form>
			<span class="change">Consolidated Hallmark Insurance Plc.</span>
		</div>
		<!--/.success-->
	</div>
	<!--/.row-->
