...
document.addEventListener("DOMContentLoaded", function(event) {
      ...
      getpaidSetup({
        ...
        callback: function(response) {
          ...
          if(response.tx.chargeResponseCode =='00' || response.tx.chargeResponseCode == '0') {
            window.location.assign("pay/success/?usage=<?php echo $_POST['usage']; ?>&agentname=<?php echo $_POST['agentname']; ?>&type=<?php echo $_POST['type']; ?>&agentid=<?php echo $_POST['agentid']; ?>&amount=<?php echo $amount; ?>&cat=<?php echo $_POST['category']; ?>&color=<?php echo $_POST['color']; ?>&chasis_no=<?php echo $_POST['chasis_no']; ?>&engine_no=<?php echo $_POST['engine_no']; ?>&regno=<?php echo $_POST['reg_no']; ?>&model=<?php echo $_POST['model']; ?>&cartype=<?php echo $_POST['car']; ?>&id_no=<?php echo $_POST['id']; ?>&id=<?php echo $_POST['identification']; ?>&occu=<?php echo $occu; ?>&address=<?php echo $_POST['address']; ?>&loc=<?php echo $_POST['loc']; ?>&dob=<?php echo $_POST['dob']; ?>&gender=<?php echo $_POST['gender']; ?>&title=<?php echo $_POST['title']; ?>&lname=<?php echo $_POST['lname']; ?>&fname=<?php echo $_POST['fname']; ?>&email=<?php echo $_POST['email']; ?>&phone=<?php echo $_POST['phone']; ?>&agent_id=<?php echo $_POST['agent_id']; ?>&year=<?php echo $_POST['year']; ?>&state_reg=<?php echo $_POST['state_reg']; ?>");
          } else {
	...
	<!-- <div class="blink"><span><a rel="facebox" href="../../preview/pay/?agentname=<?php echo $_POST['agentname']; ?>&type=Corporate&agentid=<?php echo $_POST['agentid']; ?>&usage=<?php echo $_POST['usage']; ?>&cat=<?php echo $_POST['category']; ?>&gender=<?php echo $_POST['gender']; ?>&color=<?php echo $_POST['colour']; ?>&chasis_no=<?php echo $_POST['chasis_no']; ?>&engine_no=<?php echo $_POST['engine_no']; ?>&regno=<?php echo $_POST['reg_no']; ?>&model=<?php echo $_POST['model']; ?>&car=<?php echo $_POST['car']; ?>&id_no=<?php echo $_POST['id_no']; ?>&id=<?php echo $_POST['id']; ?>&occu=<?php echo $_POST['occupation']; ?>&address=<?php echo $_POST['address']; ?>&loc=<?php echo $_POST['location']; ?>&dob=<?php echo $_POST['dob']; ?>&title=<?php echo $_POST['title']; ?>&amount=<?php echo $_POST['category']; ?>&lname=<?php echo $_POST['lname']; ?>&fname=<?php echo $_POST['fname']; ?>&email=<?php echo $_POST['email']; ?>&phone=<?php echo $_POST['phone']; ?>&agent_id=<?php echo $_POST['agent_id']; ?>&year=<?php echo $_POST['year']; ?>&state_reg=<?php echo ucfirst($_POST['state_reg']); ?>" style="background: linear-gradient(135deg, #891C2E 30%, #CCC 60%);
  padding: 10px; border: none; border-radius: 50px; width:200px; color: white; font-weight: 400; font-size: 12pt;">Pay With Debit Card</a></span>
  </div> -->
