...
100%{opacity: 1;}
    ...
    <br><br><br><br><br><br><br><br><br><br>
		...
		if($_GET['amount']>9000)
		{
        	echo '<img src="../../img/scratchcard1.png" width="241" height="140">';
		}
		elseif($_GET['amount']==5000)
		{
        	echo '<img src="../../img/scratchcard2.png" width="241" height="140">';
		}
	...
	<br><br><br>
		...
		<input name="reg_no" type="hidden" value="<?php echo $_GET['reg_no']; ?>">
		<input name="vehicle_model" type="hidden" value="<?php echo $_GET['model']; ?>">
		<input name="vehicle_name" type="hidden" value="<?php echo $_GET['car']; ?>">
		<input name="id_no" type="hidden" value="<?php echo $_GET['id_no']; ?>">
		<input name="id" type="hidden" value="<?php echo $_GET['id']; ?>">
		<input name="occupation" type="hidden" value="<?php echo $_GET['occu']; ?>">
		...
		<input name="registered_state" type="hidden" value="<?php echo $_GET['state_reg']; ?>">
		<input type="hidden" name="insured_type" value="<?php echo $_GET['type']; ?>">
